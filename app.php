...
<body>
    ...
    <section id="customisation-panel"
      ...
      <div class="customisation-card">
        ...
        <div class="customisation-style-list">
          ...
          <button type="button" class="custom-style-btn is-locked" data-theme="dark" data-style-label="Dark Mode">Dark Mode</button>
        </div>
      </div>
    </section>
  </main>
  ...
  <script>
    (function () {
      ...
      var THEME_LABELS = { ocean: 'Classic', dark: 'Dark Mode' };
      var THEME_UNLOCK_COSTS = {
        dark: { points: 30, shards: 3 }
      };
      ...
      function isThemeUnlocked(themeName) {
        if (themeName === 'ocean') return true;
